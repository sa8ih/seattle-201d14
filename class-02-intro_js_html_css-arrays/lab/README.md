...
- In preparation for lecture tomorrow, there is an example of the Learning Journal in another directory in this daily class directory. Take a look and use it as a guide and as inspiration.  We'll start working with Learning Journals tomorrow.
